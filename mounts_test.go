...
func TestMounts(t *testing.T) {
	...
	checkSHA256(
		...
		fileCaches["artifact:OpqCz--JTlCYFq_bu3489A:public/build/mozharness.zip"],
	)
	checkSHA256(
		t,
		"c075e31488502350611e9ff5740d405cc5c190f03996b26c1f47b2ec68bd14ac",
		fileCaches["urlcontent:https://github.com/taskcluster/logserver/raw/53134a5b9cbece05752c0ecc1a6c6d7c2fbf6580/node_modules/express/node_modules/connect/node_modules/multiparty/test/fixture/file/binaryfile.tar.gz"],
	)
	checkSHA256(
		t,
		"8308d593eb56527137532595a60255a3fcfbe4b6b068e29b22d99742bad80f6f",
		fileCaches["artifact:KTBKfEgxR5GdfIIREQIvFQ:SampleArtifacts/_/X.txt"],
	)
	checkSHA256(
		t,
		"e2f4c7554a5ef2992da54b122e7383d2d4531aaa54ae3ea5794631e53532e79c",
		fileCaches["urlcontent:https://raw.githubusercontent.com/taskcluster/generic-worker/9e7ee7638f7d27ccf37ef0d5ca119ede106c73ca/tutorial-audio.sh"],
	)
	checkSHA256(
		t,
		"800683ad3faff0d4f4ecb07d31c1ad1f229615835b6da6be2dabf633d844574b",
		fileCaches["artifact:To_4IZUgRgOrmR2w6UTerA:public/build/mozharness.zip"],
	)
	checkSHA256(
		t,
		"941a2c5ae826b314f289642df6ea3a8e320d66ca669fc3579abc7be9b0a50271",
		fileCaches["urlcontent:https://github.com/mozilla/gecko-dev/raw/233f30f2377f3df0f3388721901681f432b813fb/devtools/client/webide/test/app.zip"],
	)
}
